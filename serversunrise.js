//server version for displaying at sunrise
...
// Get new data every day at sunrise in Montreal
cron.schedule('0 0 * * *', () => {
  const times = suncalc.getTimes(new Date(), 45.5, -73.6); // Montreal coordinates
  const sunriseTime = times.sunrise.getHours() + ':' + times.sunrise.getMinutes();

  console.log(`Getting new data at ${sunriseTime}...`);
  getNewData();
});
